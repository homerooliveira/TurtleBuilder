...
protocol AnimationLooperDelegate: AnyObject {
    func turtleAnimatorDidEnd(_ animator: TurtleAnimator)
}

final class TurtleAnimator: NSObject, CAAnimationDelegate {
...
public class AnimatedTurtlePlatformView: PlatformView, AnimationLooperDelegate {
    ...
    internal func turtleAnimatorDidEnd(_ animationLooper: TurtleAnimator) {
        self.animator = nil
    }
